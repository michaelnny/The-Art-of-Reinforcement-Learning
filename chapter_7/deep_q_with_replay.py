...
class NaiveDeepQAgent:
    ...
    def calc_loss(self, transitions):
        ...
        with torch.no_grad():
            q_tp1 = self.network(s_tp1)  # [batch_size, action_dim]
...
def main(argv):
    """Trains naive deep Q learning with experience replay agent.
    ...
    logging.info(f'Runs naive deep Q learning with experience replay on {device}')
