...
class DoubleDQNAgent:
    """Double DQN agent for interacting with the environment and do learning."""
    ...
    def calc_loss(self, transitions):
        ...
        with torch.no_grad():
            ...
            # alternative option
            # max_q_tp1 = q_tp1[torch.arange(0, s_t.shape[0]), best_a_tp1] # [batch_size]
...
def main(argv):
    ...
    logging.info(f'Runs double DQN agent on {device}')
