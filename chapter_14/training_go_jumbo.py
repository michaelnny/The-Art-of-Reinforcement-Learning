...
flags.DEFINE_integer('replay_capacity', 500000 * 100, 'Replay buffer capacity is number of game * average game length. ')
...
flags.DEFINE_multi_integer(
    'lr_milestones', [200000, 400000, 600000], 'The number of training steps at which the learning rate will be decayed.'
)
...
flags.DEFINE_integer(
    'num_simulations', 800, 'Number of simulations per MCTS search, this applies to both self-play and evaluation processes.'
)
flags.DEFINE_integer(
    'num_parallel',
    8,
...
flags.DEFINE_string('logs_dir', './logs/go/19x19', 'Path to save statistics for self-play, training, and evaluation.')
flags.DEFINE_string('eval_games_dir', './pro_games/go/19x19', 'Path contains evaluation games in sgf format.')
flags.DEFINE_string('save_sgf_dir', './selfplay_games/go/19x19', 'Path to selfplay and evaluation games in sgf format.')
